...
export const IMMEDIATE_DIRECT_REPLAY_LOG_TAGS = new Set([
  ...
  'GET_CHECKOUT_STATUS_LINE_STATUS_REQUEST',
  'GET_REDIRECTION_URL_GFL_REQUEST'
]);
...
export const SELF_TRIGGER_FALLBACK_WAIT_TIMEOUT_OVERRIDES_MS = {
  ...
  'LenderLineStatus_REQUEST': 2_000,
  'VerifyLenderOTPRequest-LSP_REQUEST': 4_000,
  'LSP-GetStatus_REQUEST': 3_000,
  'GENERATE_TOKEN_API_REQUEST': 2_000,
  'FECTH_LOAN_APPLICATION_DATA_API_REQUEST': 2_000,
  'FETCH_LOAN_APPLICATION_DATA_API_REQUEST': 2_000
};
