...
import { extractPayload, getApiForLogTag as getApiFromConfig, getEndpointConfig, SERVICE_MAP, SKIP_DESTINATIONS, isAsyncParallelApi, LENDER_ORG_ID_TO_ID_MAP, normalizeSourceDestination } from './config.js';
...
export class ReplayOrchestrator {
  ...
  static extractLenderOrgIds(logs) {
    ...
    logger.info('Extracted lender org ID to ID mapping from logs', { count: Object.keys(lenderMap).length, orgIds: [...orgIds] });
    return lenderMap;
  }
