...
export ART_FINAL_STORE_DIR="${ART_FINAL_STORE_DIR:-/home/prajwalbtegur/art-final-store}"
...
export ART_FILTERED_STORE_DIR="${ART_FILTERED_STORE_DIR:-/home/prajwalbtegur/logsStore}"
export ART_FILTERED_STORE_TOTAL_ORDER_LIMIT="${ART_FILTERED_STORE_TOTAL_ORDER_LIMIT:-50}"
...
export SESSION_TOKEN="${SESSION_TOKEN:-LSP3c476b05418a41bf905d6c6ad06820a4}"
